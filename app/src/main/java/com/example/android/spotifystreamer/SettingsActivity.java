        ...
        if (preference instanceof CheckBoxPreference) {
            onPreferenceChange(preference,
                    PreferenceManager
                            ...
                            .getBoolean(preference.getKey(), getResources().getBoolean(R.bool.pref_notifications_default)));
        } else {
            onPreferenceChange(preference,
                    PreferenceManager
                            .getDefaultSharedPreferences(preference.getContext())
                            .getString(preference.getKey(), getString(R.string.pref_country_code_default)));
        }
    }
